  ...
  return (
    <>
      <div class="flex justify-center h-[40vh]  mt-6">
        <img
          src="	https://c.housingcdn.com/demand/s/client/common/assets/gptw.f05b9fda.jpg"
          alt=""
        />
      </div>
      <div class="flex justify-center h-14 mb-6 mt-6">
        <p className=" justify-items-center mt-2 text-4xl mr-1 text-slate-700 font-bold ">
          Part of
        </p>
        <img
      ...
      <footer aria-label="Site Footer" class="bg-black -mb-5">
        <div class=" px-4 py-16 sm:px-6 lg:px-8">
          <div class="flex flex-row  gap-4 rounded-lg p-6 shadow-lg  ">
            <span class="text-gray-700 w-[15%]">Our Brands</span>
            <div class="flex justify-center space-x-32   bg-black filter grayscale overflow-hidden w-[70%]">
              <img
                class="h-6 ml-3"
                src="https://cdn.sanity.io/images/gxmub2ol/production/f4923939d76bc0f1eeaab7b20d8f1e87daf3cd25-3720x500.png"
                alt=""
              />
              <img
                class="h-6 "
                src="https://seeklogo.com/images/M/makaan-com-logo-36CD0FB210-seeklogo.com.png"
                alt=""
              />
              <img
                class="h-10 "
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKlhoOS_j0kBLaVy4c1pa2qqdU6hVhjkIhNvjoqm6cOMXHTu7-5HqKoa8LHsyYRVvT0SOKZaZuaag&usqp=CAU&ec=48600112"
                alt=""
              />
            </div>
          </div>
